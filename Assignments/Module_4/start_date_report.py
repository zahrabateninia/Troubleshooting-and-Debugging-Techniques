...
# Purpose of this script: List employees who started on or after a user-specified date, based on data retrieved from a remote CSV file.
...
#  Sort the CSV data by the start date (which is the fourth column, row[3]).
